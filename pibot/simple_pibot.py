...
# The NeoPixel code in this class has been adapted from the Adafruit NeoPixel code
...
class PiBot:
    ...
    def theaterChase( self, color, wait ):
        
        for j in range( 10 ):   # do 10 cycles of chasing
            
            for q in range( 3 ):
                
                for i in range( 0, self.NUM_NEO_PIXELS, 3 ):
                    
                    # Turn every 3rd pixel on
                    self.setNeoPixelColour( i + q, color[ 0 ], color[ 1 ], color[ 2 ] ) 
        
                time.sleep( wait )
     
                for i in range( 0, self.NUM_NEO_PIXELS, 3 ):
                    
                    # Turn every 3rd pixel off
                    self.setNeoPixelColour( i + q, 0, 0, 0 ) 
